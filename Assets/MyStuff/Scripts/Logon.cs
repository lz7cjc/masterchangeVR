...
{
    //remote
   string posturl = "http://masterchange.today/php_scripts/login.php";
    //local
        ...
        else
        {
           ...
           // Debug.Log("json returned: " + loadedPlayerData);
            ...
            else
            {
                ...
                PlayerPrefs.SetInt("SkipLearningScreenInt", Convert.ToInt32(loadedPlayerData.data[0].SkipLearningScreenInt));
